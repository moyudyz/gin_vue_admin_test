<template>
  <ul class="icon-list clearfix">
    ...
    <li>
      <span>
        <i class="el-icon-partly-cloudy" />
        <span class="icon-name">el-icon-partly-cloudy</span></span>
    </li>
    <li>
      <span>
        <i class="el-icon-cloudy-and-sunny" />
    ...
    <li>
      <span>
        <i class="el-icon-ice-cream-square" />
