  ...
  <div>
    <el-form ref="form" :model="form" label-width="80px">
      <el-row>
        ...
        <el-col :span="10"><el-input v-model="form.name" /></el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="10"><el-switch v-model="form.delivery" /></el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="10"><el-input v-model="form.desc" type="textarea" /></el-col>
      </el-row>
      <el-row>
